...
library BancorPowerMinimal {
    ...
    */
    uint256 private constant FIXED_1 = 1<<127;
    uint256 private constant FIXED_2 = 1<<128;
    uint256 private constant MAX_NUM = 1<<129;
    ...
    */
    ...
    /**
        General Description:
            ...
            Calculate an integer approximation of (_baseN) ^ (_expN / _expD) * 2 ^ precision.
