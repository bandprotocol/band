...
class ClaimXFNModal extends React.Component {
  state = {
    loading: true,
    snapShots: [
      { date: 1570449600 - 86400 * 6, bandAmount: new BN(0) },
      { date: 1570449600 - 86400 * 5, bandAmount: new BN(0) },
      { date: 1570449600 - 86400 * 4, bandAmount: new BN(0) },
      { date: 1570449600 - 86400 * 3, bandAmount: new BN(0) },
      { date: 1570449600 - 86400 * 2, bandAmount: new BN(0) },
      { date: 1570449600 - 86400 * 1, bandAmount: new BN(0) },
      { date: 1570449600, bandAmount: new BN(0) },
    ],
    bandAvg: new BN(0),
    pendingTx: false,
  }
