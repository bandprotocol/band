export default {
  overview: [
    ...
    `Pick the query key for data lookup. For instance, key •EPL/2018-2019/20190512/WAT-WHU for Watford vs West Ham United at 2019/05/12. Each dataset has its own method to construct a valid key.`,
  ],
  description: [
