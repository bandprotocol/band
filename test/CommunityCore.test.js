...
contract('CommunityCore', ([_, owner, alice, bob, carol]) => {
  ...
  it('should auto-inflate properly', async () => {
    ...
    (await this.core.curveMultiplier()).should.bignumber.eq(
    ...
    (await this.comm.balanceOf(this.core.address)).should.bignumber.eq(
      new BigNumber(10),
    );
    (await this.core.curveMultiplier()).should.bignumber.eq(
      new BigNumber(826446280991),
    );
  });
